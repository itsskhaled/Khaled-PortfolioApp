        ...
        <div className="fixed landscape:pt-5 w-full text-center z-999">
            ...
            >
                <ul className="pt-28 landscape:overflow-hidden landscape:text-2xl text-2xl sm:text-2xl lg:text-5xl  my-5 uppercase" ref={itemsRef}>
                    <li className="my-5 cursor-pointer"><a href="/">Home</a></li>
                    <li className="my-5 cursor-pointer"><a href="/AboutMe">About</a></li>
                    <li className="my-5 cursor-pointer"><a href="/AllProjects">Projects</a></li>
                    <li className="my-5 cursor-pointer"><a href="/Contact-Me">Contact</a></li>
                </ul>
            </div>
        </div>
    );
