...
export default function ProjectsAll() {
    ...
    return (
        <section className="w-full min-h-screen landscape-mobile-h">
            ...
            {ProjectsHomeData.map((project, i) => {
                return (
                    <Link key={i} href={project.href} target="_blank" rel="noopener noreferrer">
                        <div ref={imageRef} className="w-[95%] h-[800px] m-auto my-10">
                            <h1 className="absolute py-5 px-5 text-9xl text-black">0{project.id}</h1>
