...
export const ProjectsHomeData = [
  {
    id: "1",
    slug: "urbanzo-ecommerce",
    name: "E-Commerce | Urbanzo",
...
export const ProjectDetails = [
  {
    ...
    Services: "uxui, front-end",
    Duration: "3 days",
    Budget: "free👀",
    Overview:
      "My goal is to create a seamless and intuitive shopping experience that connects customers with high-quality fashion essentials. This E-Commerce platform is designed to showcase a curated collection of men’s and women’s jackets, along with premium bags, presented through a clean and modern interface. By focusing on usability, visual clarity, and fast performance, the project ensures that customers can browse, compare, and purchase products effortlessly across all devices.",
    Objective:
      "The objective behind building this store was to create a professional and scalable online shopping solution that meets the needs of modern fashion brands. The platform provides a smooth user journey—from product discovery to checkout—while maintaining a strong emphasis on branding, product presentation, and customer trust.",
    Process:
